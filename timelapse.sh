...
nice -n 10 ffmpeg -f concat -safe 0 -i $PIC_DIR/timelapse.txt -vcodec libx264 -vf format=yuv420p -vf fps=24 -pix_fmt yuv420p $yesterday_dir/timelapse.mp4
ln -sf $yesterday_dir/timelapse.mp4 $PIC_DIR/yesterday_timelapse.mp4
